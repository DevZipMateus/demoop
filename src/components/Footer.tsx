...
const Footer = () => {
  ...
  return <footer className="bg-demoop-blue/95 backdrop-blur-md text-white pt-14 pb-8 relative z-10 border-t border-white/10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-10">
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <a href="https://www.instagram.com/demoop" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://wa.me/5548999982838" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="text-white/80 hover:text-white transition-colors duration-300" onClick={e => {
                e.preventDefault();
              ...
              <li>
                <a href="#about" className="text-white/80 hover:text-white transition-colors duration-300" onClick={e => {
                e.preventDefault();
              ...
              <li>
                <a href="#services" className="text-white/80 hover:text-white transition-colors duration-300" onClick={e => {
                e.preventDefault();
              ...
              <li>
                <a href="#how-it-works" className="text-white/80 hover:text-white transition-colors duration-300" onClick={e => {
                e.preventDefault();
              ...
              <li>
                <a href="#contact" className="text-white/80 hover:text-white transition-colors duration-300" onClick={e => {
                e.preventDefault();
