      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl font-light mb-4 sm:mb-6 opacity-0 animate-slide-up tracking-tight leading-tight">
              <span className="block text-demoop-primary">conheça</span>
              <span className="block text-demoop-blue">nossos produtos</span>
            </h1>
            
            <p className="text-base sm:text-lg md:text-xl lg:text-lg xl:text-xl text-foreground/80 mb-6 sm:mb-8 opacity-0 animate-slide-up animation-delay-200 font-light leading-relaxed">
              A limpeza que faz a diferença
            </p>
            
            <p className="text-sm sm:text-base md:text-lg lg:text-base text-muted-foreground mb-8 sm:mb-10 opacity-0 animate-slide-up animation-delay-300 leading-relaxed">
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6 opacity-0 animate-slide-up animation-delay-600">
              ...
              >
                <CardHeader className="text-center pb-4 p-4 sm:p-6">
                  <div className="flex items-center gap-4">
                    <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r ${product.color} flex items-center justify-center text-xl sm:text-2xl shadow-lg group-hover:shadow-xl transition-all duration-300`}>
                      {product.icon}
                    </div>
